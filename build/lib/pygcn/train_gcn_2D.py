...
from pygcn.load_labels import load_labels
...
paths_labels = os.listdir('/Users/mac/Desktop/AUGCN/pygcn/labels/AVEC2014_DepressionLabels/Training_DepressionLabels')
...
for i in range(len(selected_paths_labels)):
    selected_paths_labels[i] = '/Users/mac/Desktop/AUGCN/pygcn/labels/AVEC2014_DepressionLabels/Training_DepressionLabels/' + selected_paths_labels[i]
...
# print(labels)
labels = load_labels(paths_features, paths_labels)
